...
class PrincipalController:
    def get_all_principals(self):
        try:
            ...
            return abort(404, message=ErrorResponse(404, "No Principal Found"))
    ...
    def get_single_principal(self, principal_id):
        try:
            ...
            return abort(
                404, message=ErrorResponse(404, "No Principal with given Id Found")
            )
    ...
    def approve_principal(self, principal_id):
        try:
            ...
            return abort(409, message=ErrorResponse(409, "Principal Already Present"))
