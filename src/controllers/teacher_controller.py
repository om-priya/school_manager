...
class TeacherController:
    def get_all_teacher(self):
        try:
            ...
            return SuccessResponse(
                200, "Here's the list of Teachers", res_data
            ).get_json()
        except DataNotFound:
            return abort(
                404, message=ErrorResponse(404, "No Teachers Found").get_json()
            )
    ...
    def get_single_teacher(self, teacher_id):
        try:
            ...
            return SuccessResponse(
                200, "Here's the details of Teacher", res_data
            ).get_json()
        except DataNotFound:
    ...
    def approve_teacher(self, teacher_id):
        try:
            ...
            return abort(
                409, message=ErrorResponse(409, "Teacher Can't be Approved").get_json()
            )
