...
class TestHelperFunction:
    def test_check_empty_data_valid_res_data(self):
        valid_res_data = [
            ("Om", "Priya"),
            ("Abhay", "Agrawal"),
            ("Millind", "Bhatnagar"),
    ...
    def test_check_empty_data_invalid_res_data(self):
        invalid_res_data = []
    ...
    def test_fetch_salary_history_with_data(
        self, monkeypatch, mock_execute_returning_query_valid_data, capsys
    ):
        monkeypatch.setattr(
    ...
    def test_fetch_salary_history_with_no_data(
        self, monkeypatch, mock_execute_returning_query_no_data, capsys
    ):
        monkeypatch.setattr(
            "src.controllers.helper.helper_function.DatabaseAccess.execute_returning_query",
    ...
    def test_fetch_salary_history_with_error(
        self, monkeypatch, mock_execute_returning_query_with_error
    ):
        monkeypatch.setattr(
            "src.controllers.helper.helper_function.DatabaseAccess.execute_returning_query",
