...
def test_is_logged_in_valid_cred(monkeypatch):
    monkeypatch.setattr(
    ...
    monkeypatch.setattr(
        "src.controllers.user_controller.hash_password", lambda *args: "hashed_password"
    )
    monkeypatch.setattr(
...
def test_is_logged_in_invalid_cred(monkeypatch):
    monkeypatch.setattr(
        "src.controllers.user_controller.validate.pattern_validator",
        lambda *args: "anbcde",
    )
...
def test_is_logged_in_pending_user(monkeypatch):
    monkeypatch.setattr(
        "src.controllers.user_controller.validate.pattern_validator",
        lambda *args: "anbcde",
    )
...
def test_is_logged_in_deactivated_user(monkeypatch):
    monkeypatch.setattr(
        "src.controllers.user_controller.validate.pattern_validator",
        lambda *args: "anbcde",
    )
...
def test_sign_up_principal(monkeypatch, mocker):
    options_pattern = [
        "dummy",
        "dummy",
        "dummy",
...
def test_sign_up_teacher(monkeypatch, mocker):
    options_pattern = [
        "dummy",
        "dummy",
        "dummy",
