...
def test_read_event_with_no_data(
    monkeypatch, mock_execute_returning_query_no_data, dummy_event_handler_obj, capsys
):
    monkeypatch.setattr(
        "src.controllers.handlers.event_handler.DatabaseAccess.execute_returning_query",
...
def test_create_event_with_no_error(
    monkeypatch, mock_execute_non_returning_query, dummy_event_handler_obj, capsys
):
    monkeypatch.setattr(
