...
def test_view_issue_with_no_data(
    monkeypatch, mock_execute_returning_query_no_data, dummy_issue_handler_obj, capsys
):
    monkeypatch.setattr(
        "src.controllers.handlers.issue_handler.DatabaseAccess.execute_returning_query",
...
def test_raise_issue_with_no_error(
    monkeypatch, mock_execute_non_returning_query, dummy_issue_handler_obj, capsys
):
    monkeypatch.setattr(
