...
def test_super_admin_menu(monkeypatch, mocker, dummy_user_screen_obj, capsys):
...
def test_principal_menu(monkeypatch, mocker, dummy_user_screen_obj, capsys):
...
def test_teacher_menu(monkeypatch, mocker, dummy_user_screen_obj, capsys):
