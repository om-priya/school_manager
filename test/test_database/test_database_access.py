...
def test_execute_non_returning_query_with_params(mock_database_connection):
    query = ""
    params = [("om",), ("Priya",)]
...
def test_execute_non_returning_query_without_params(mock_database_connection):
    query = ""
    params = None
    mock_cursor = mock_database_connection
    DatabaseAccess.execute_non_returning_query(query, params=params)
...
def test_execute_returning_query_with_params(mock_database_connection):
    query = ""
    params = [("om",), ("Priya",)]
    mock_cursor = mock_database_connection
...
def test_execute_returning_query_without_params(mock_database_connection):
    query = ""
    mock_cursor = mock_database_connection
